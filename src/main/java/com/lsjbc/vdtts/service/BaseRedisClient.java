package com.lsjbc.vdtts.service;
...
public class BaseRedisClient {
     ...
     * @return 对应的多个键值
     */
    public Map<Object, Object> hmget(
            String key
    ) {
