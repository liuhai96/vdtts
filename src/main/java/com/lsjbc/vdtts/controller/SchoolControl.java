 ...
 **/
	...
	//修改驾校信息
	@RequestMapping(value = "/updateschoolInfo",produces = {"application/json;charset=UTF-8"})
	public String updateschoolInfo(School school){
		return JSON.toJSONString(schoolService.updateschoolInfo(school));
	}
