		...
		<div class="cooperate-form">
			<div class="form">
				...
				<div class="layui-input-block">
					<button class=" layui-btn layui-btn-warm" lay-submit lay-filter="formDemo1">修改图片提交</button>
				</div>
				<div style="text-align: center;">
					<br><br><br>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input disabled="disabled" type="text" class="layui-input" value="${sessionScope.student.SName}">
							</div>
							<label class="layui-form-label">性别：</label>
							<div class="layui-input-inline">
								<input disabled="disabled" type="text" class="layui-input" value="${sessionScope.student.SSex}">
							</div>
						</div>
					</div>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input disabled="disabled" type="text" class="layui-input" value="${sessionScope.student.SSfz}">
							</div>
							<label class="layui-form-label">联系方式:</label>
							<div class="layui-input-inline">
								<input disabled="disabled" id="sphone" type="text" class="layui-input" value="${sessionScope.student.SPhone}">
							</div>
						</div>
					</div>
