...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs" lay-event="delete">删除教练</a>
</script>
...
<script>
    ...
    table.render({
            ...
            ,url: '/teacherController/selectTeacherInfo' //数据接口
            ,title: '驾校表'
            ,page: true //开启分页
            ,limit: 5 //每行显示5页
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'tId', title: '序号', width:80, sort: true, fixed: 'left', }
                ,{field: 'tName', title: '姓名', width:80}
                ,{field: 'aAccount', title: '账号', width:80}
                ,{field: 'tSex', title: '性别', width:80, sort: true, totalRow: true}
                ,{field: 'tSfz', title: '身份证号', width: 110}
                ,{field: 'tPhone', title: '电话号码', width: 110}
                ,{field: 'schoolName', title: '所属驾校', width: 110}
                ,{field: 'tTeach', title: '允许教学', width: 110}
                ,{field: 'tLock', title: '允许登录', width:110 }
                ,{field: 'tLicenseTime', title: '获取驾照时间', width:120 }
                ,{field: 'tCount', title: '本月毕业学员数', width:130 }
                ,{field: 'tLimit', title: '本月限制毕业学员数', width:130 }
                // ,{field: 'tLicenseTime', title: '获取驾照时间', width:130, hide:'true'}
        ...
        var addschool = null;
            ...
            switch(obj.event){
                ...
                case "search":
                    ...
                    //执行重载
                    table.reload('demo', {
                        url: "/teacherController/selectTeacherInfo",
                        page: {
                            curr: 1 //重新从第 1 页开始
                        }
                        ,where: {
